...
class GetAllCouriers final : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-get-all-couriers";

  GetAllCouriers(const userver::components::ComponentConfig& config,
...
void AppendGetAllCouriers(userver::components::ComponentList& component_list) {
  component_list.Append<GetAllCouriers>();
}
